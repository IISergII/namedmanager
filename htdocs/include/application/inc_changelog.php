...
class changelog {
    ...
    public $id_server = 0;  // name server ID (if appropiate)
    public $id_domain = 0;  // domain ID (if appropiate)
    public $username;
...
// end of changelog()
    ...
    public function log_post($log_type, $log_contents, $timestamp = NULL) {
...
// end of log_post
    ...
    public function log_retention_clean() {
