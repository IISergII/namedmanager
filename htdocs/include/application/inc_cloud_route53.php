...
require_once (dirname(__FILE__) . "/../vendor/aws-sdk/aws-autoloader.php");
...
class cloud_route53 {
    ...
    public function select_account($id_name_server) {
        ...
        $this->obj_route53 = Route53Client::factory(['key' => $key["route53_access_key"],
...
// end of select_account
    ...
    public function select_domain($id_domain) {
...
// end of select_domain
    ...
    public function fetch_records_local() {
...
// end of fetch_records_local()
    ...
    public function fetch_records_remote() {
...
// end of fetch_records_remote()
    ...
    public function action_sync_records() {
        ...
        $soa_record = []; // we need to fetch and adjust the SOA record.
        $merge_hash_route53 = [];
        $data_records_route53 = [];
        ...
        $ids_local_created = []; // array of Local IDs to create in Route53
        $ids_route53_deleted = []; // array of Route53 IDs to delete from Route53 (has changed)
        $ids_route53_nochange = []; // records with no change.
...
// end of action_create_domain
    ...
    public function action_update_records() {
