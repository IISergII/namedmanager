...
class name_server {
    ...
    public $id;  // ID of the server to manipulate (if any)
    public $data;
...
// end of verify_id
    ...
    public function verify_server_name() {
...
// end of action_update
    ...
    public function action_update_config_version($version) {
...
// end of action_update_config_version
    ...
    public function action_update_log_version($version) {
