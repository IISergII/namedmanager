...
class form_input {
    ...
    public $formname;   // name of the form - needs to be unique per form
    public $language = "en_us"; // language to use for the form labels.
    public $action;   // page to process the data
    public $method;   // method to use - POST or GET
    public $sql_query;   // SQL query used to fetch data
    public $subforms;   // associative array of sub form titles and contents
    public $subforms_grouped;  // grouped subform items
    public $structure;   // array structure of all variables and options
    public $actions;   // array structure of javascript actions
    public $sessionform;  // If this value is set, the value is the name of the session variable
     ...
     */
    public function add_input($option_array) {
    ...
    public function add_action($trigger_field, $trigger_value, $target_field, $action_type) {
    ...
    public function load_data_error() {
    ...
    public function load_data_object($array) {
...
// end of load_data_object
    ...
    public function load_data_session() {
    ...
    public function render_sessionform_messagebox() {
    ...
    public function render_row($fieldname) {
...
//		}
    ...
    /*
      ...
      $option_array["values"] = [];			Array of values - used for radio or dropdown type fields
      $option_array["translations"] = [];		Associate array used for labeling the values in radio or dropdown type fields

     */

    public function render_field($fieldname) {
        ...
        switch ($this->structure[$fieldname]["type"]) {
            ...
            case "dropdown":
                ...
                if (is_string($this->structure[$fieldname]["values"])) {
                    ...
                    $this->structure[$fieldname]["values"] = [];
    ...
    public function render_javascript() {
        ...
        foreach (array_keys($this->structure) as $fieldname) {
            ...
            if (!empty($this->structure[$fieldname]["options"]["autocomplete"]) && $this->structure[$fieldname]["type"] == "input") {
                ...
                print "$(function() {\n";
                print "\tpubliclic autocomplete_$fieldname = [" . format_arraytocommastring($values, '"') . "];\n";
