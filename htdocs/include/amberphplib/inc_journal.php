...
class journal_base {
    ...
    public $journalname;  // name of the journal (used to store the entries in the DB)
    public $language = "en_us"; // language to use for the labels
    public $structure;   // used to hold the structure of the journal entry selected
    public $filter = [];  // structure of the filtering
    public $option = [];  // structure for fixed filter options
    ...
    public function prepare_set_journalname($journalname) {
        log_debug("journal_base", "Executing prepare_set_journalname($journalname)");

        $this->journalname = $journalname;
    }

    public function prepare_set_content($content) {
    ...
    public function prepare_set_title($title) {
    ...
    public function prepare_predefined_optionform() {
    ...
    public function verify_journalid() {
...
class journal_input extends journal_base {
    ...
    public function render_text_form() {
    ...
    public function render_file_form() {
