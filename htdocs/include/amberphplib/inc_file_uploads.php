...
class file_storage {
    ...
    public function load_data_bytype() {
    ...
    public function verify_upload_form($fieldname, $acceptable_formats = NULL) {
...
// end of action_create
    ...
    public function action_update_form($fieldname) {
...
// end of action_update_form
    ...
    public function action_update_file($filepath) {
...
// end of action_update_file
    ...
    private function action_update_var($blob) {
...
// end of action_update_var
    ...
    public function filedata_render() {
...
// end of filedata_var
    ...
    public function filedata_write($filename) {
