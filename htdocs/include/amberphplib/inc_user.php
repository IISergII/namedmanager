...
class user_auth {
    ...
    public $method;  // mode of authentication
    public $blacklist_enable; // blacklist on/off
    public $blacklist_limit; // max num attempts before being blacklisted
    ...
    public function getSessionDatabase($sql_obj) {
...
// end of check_online()
    ...
    public function login($instance, $username, $password) {
...
// end of login()
    ...
    public function login_instance_init($instance) {
...
// end of logout
    ...
    public function session_init($userid, $username) {
...
// end of permissions_init
    ...
    public function permissions_get($type) {
...
class blacklist {
    ...
    public $blacklist_enable;  // whether or not features are enabled/disabled
    public $blacklist_limit;  // max num of attempts before blacklisting
    public $ipaddress;   // address to run functions against.
