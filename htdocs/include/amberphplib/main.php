...
require_once "inc_sql.php";
require_once "inc_ldap.php";
...
// Misc Functions
require_once "inc_misc.php";

// Template processing engines
require_once "inc_template_engines.php";

// Functions/classes for data entry and processing
require_once "inc_forms.php";
require_once "inc_tables.php";
require_once "inc_file_uploads.php";

// Journal System
require_once "inc_journal.php";

// Menus
require_once "inc_menus.php";

// Phone Home Functions
require_once "inc_phone_home.php";
