...
class table {
    ...
    public $tablename;    // name of the table - used for internal purposes, not displayed
    public $language = "en_us";  // language to use for the form labels.
    public $columns;    // array containing the list of all the columns to display
    public $columns_order;   // array containing columns to order by
    public $columns_order_options;  // array containing columns that can be sorted - if set to none, then the sortable
    // option box will not appear

    public $total_columns;   // array of columns to create totals for
    public $total_rows;   // array of columns to create per-row totals for
    public $total_rows_mode = "subtotal"; // row total modes
    //
    ...
    public $links;    // array of links to place in a final column
    public $links_columns;   // array used to define links that belong inside columns
    public $structure;    // contains the structure of all the defined columns.
    public $filter = [];   // structure of the filtering
    public $option = [];   // fixed options to add to the option form
    public $data;    // table content
    public $data_render;   // processed table content
    public $data_num_rows;   // number of rows
    public $sql_obj;    // object used for SQL string, queries and data
    public $obj_ldap;    // object used for LDAP queries
    public $render_columns;   // human readable column names
    public $limit_rows;   // maximum number of table rows to disable at any stage - if the max is reached,
    ...
    public $limit_start;   // internal only: start of displayed range
    public $limit_stop;   // internal only: end of displayed range
    ...
    public function add_column($type, $name, $dbname) {
    ...
    public function add_link($name, $page, $options_array) {
    ...
    public function add_filter($option_array) {
    ...
    public function add_fixed_option($fieldname, $value) {
    ...
    public function custom_column_label($column, $label) {
    ...
    public function custom_column_link($column, $link) {
    ...
    public function init_data_ldap() {
    ...
    public function load_data_ldap($filter, $base_dn = NULL) {
    ...
    public function render_column_names() {
        foreach ($this->columns as $column) {
    ...
    public function render_field($column, $row) {
    ...
    public function render_table_prepare() {
...
// end of render_table_prepare
    ...
    public function render_table_html() {
...
// end of render_table_html
    ...
    public function render_table_csv() {
...
// end of render_table_csv
    ...
    public function render_table_pdf($template = NULL) {
