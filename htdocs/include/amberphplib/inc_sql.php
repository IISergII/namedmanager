...
class sql_query {
    ...
    public $structure;  // structure available to be used to build SQL queries
     ...
     */
    public $string;  // SQL statement to use
    public $data_num_rows; // number of rows returned
    public $data;  // associate array of data returned
    public $db_type;  // (currently unused, in future this will hold the type of database)
    public $db_link;  // database connection/session
    public $db_resource; // used to track DB calls, eg resource value between query and num rows
    ...
    public function session_init($db_type, $db_hostname, $db_name, $db_username, $db_password) {
...
// end of session_init
    ...
    public function session_select_db($db_name) {
...
//        $this->data_num_rows = NULL;
    ...
    public function fetch_affected_rows() {
    ...
    public function prepare_sql_settable($tablename) {
    ...
    public function prepare_sql_addfield($fieldname, $dbname = NULL) {
    ...
    public function prepare_sql_addjoin($joinquery) {
    ...
    public function prepare_sql_addwhere($sqlquery) {
    ...
    public function prepare_sql_addorderby($fieldname) {
    ...
    public function prepare_sql_addorderby_asc($fieldname) {
    ...
    public function prepare_sql_addorderby_desc($fieldname) {
    ...
    public function prepare_sql_addgroupby($sqlquery) {
    ...
    public function prepare_sql_setlimit($num) {
    ...
    public function stats_diskusage($dbname = NULL) {
