...
class phone_home {
    ...
    public $url = "https://www.amberdms.com/api/opensource/amberdms_phone_home.php";
    public $url_ssl = true; // set to true to enforce validation of SSL certificate
    public $stats; // used to hold stats about the system for submission upstream
...
// end of check_enabled
    ...
    public function check_phone_home_timer() {
...
// end of check_phone_home_timer
    ...
    public function stats_generate() {
