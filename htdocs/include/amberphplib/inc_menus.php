...
class menu_main {
    ...
    public $page;   // page that is currently selected - this value is used by the render
    // functions for showing which level/path is highlighted

    public $menu_order;  // array containing the order of the menu levels
    public $menu_structure;  // all the data for the menu entries that the user has access perms for
    public $option_remember;  // if set, if the page variable doesn't match any known pages in the menu, display
    ...
    function load_data() {
        ...
        if (user_online()) {
            ...
            // (legacy) For system without a private permissions group, add the ID of 0
            $user_permissions[] = "0";
        } else {
...
// end of load_data
    ...
    public function render_menu_standard() {
...
// end of render_menu_standard
    ...
    public function render_menu_expanded() {
...
// end of render_menu_expanded
    ...
    public function render_menu_breadcrumbs() {
...
class menu_nav {
    ...
    public $structure;  // holds the structure of the navigation menu
    ...
    public function add_item($title, $link, $selected = NULL) {
