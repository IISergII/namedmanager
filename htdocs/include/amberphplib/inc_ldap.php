...
class ldap_query {
    ...
    public $ldapcon;   // reference to LDAP database session - if unset
    // will default to last LDAP database opened.

    public $srvcfg;   // settings for server to connect to.
    public $record_dn;   // DN for a specific entry
    public $data;   // used to store queried entries
    public $data_num_rows;  // used to store num of entries
