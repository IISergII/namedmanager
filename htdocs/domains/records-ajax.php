...
class page_output {
    ...
    public $num_records_mx;
    public $num_records_ns;
    public $num_records_custom; // for this pagination instance
    public $num_records_custom_total;
    public $offset;
    public $is_standard;
    ...
    public function get_pagination_row() {
...
//                            if ($record["name"] == "@" || $record["name"] == "*" || preg_match("/^\*\.[A-Za-z0-9:._-]+$/", $record["name"])) {
                            if ($record["name"] == "@" || $record["name"] == "*" || preg_match("/^\*\.[\\w:._-]+$/", $record["name"])) {
