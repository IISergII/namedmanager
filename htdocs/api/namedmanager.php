...
require_once "../include/amberphplib/main.php";
require_once "../include/application/main.php";

class api_namedmanager {

    public $auth_server;  // ID of the DNS server that has authenticated.
    public $auth_online;  // set to 1 if authenticated
    public $auth_admin;  // set to 1 if authenticated as admin
    public $auth_group;  // ID of the group the DNS server belongs to

    /*
      constructor
     */

    public function api_namedmanager() {
    ...
    public function authenticate($server_name, $api_auth_key) {
...
// end of authenticate
    ...
    public function log_write($timestamp, $log_type, $log_contents) {
...
// end of check_update_version
    ...
    public function set_update_version($version) {
...
// end of set_update_version
    ...
    public function update_serial($id_domain) {
...
// end of fetch_domains
    ...
    public function fetch_records($id_domain) {
